...
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_DATE;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_DEGREES;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_HUMIDITY;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_MAX_TEMP;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_MIN_TEMP;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_PRESSURE;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_WEATHER_ID;
import static com.example.android.sunshine.data.provider.WeatherContract.WeatherEntry.COLUMN_WIND_SPEED;
